---
title: "Automating Topology Corrections for Fragmented Networks"
year: 2025
tags:
  - llm
  - spatial-ml
thumbnail: /images/projects/fragmented-network-topology.jpg
description: "An LLM-based interpretable model for correcting fragmented network structures in pedestrian, cycling, and utility infrastructure."
---
...
Figure 1. Left: Raw polygon centerline results from a semantic segmentation model. Right: Manually corrected network of the same area, prioritizing connectivity, routability, and simplicity.
