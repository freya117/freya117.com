        ...
        <div className="flex flex-col px-8 py-5 -my-5 transition-colors ease-in-out -mx-7 group sm:flex-row sm:justify-between sm:items-end focus:bg-back-secondary focus:text-accent">
          <div>
            ...
            <div className="font-medium text-fore-subtle">
              ...
              <br/><br/>
              Prior to NYU, I completed my M.S. in Electrical Engineering &amp; Computer Science at MIT, advised by <a href="https://web.mit.edu/phillipi/" className="font-medium text-accent underline decoration-accent/40 underline-offset-2 hover:text-accent-hover hover:decoration-accent">Prof. Phillip Isola</a> at <a href="https://www.csail.mit.edu/" className="font-medium text-accent underline decoration-accent/40 underline-offset-2 hover:text-accent-hover hover:decoration-accent">CSAIL</a> — concurrently pursuing a Master in City Planning at the <a href="https://cityform.mit.edu/" className="font-medium text-accent underline decoration-accent/40 underline-offset-2 hover:text-accent-hover hover:decoration-accent">City Form Lab</a> under <a href="https://dusp.mit.edu/people/andres-sevtsuk" className="font-medium text-accent underline decoration-accent/40 underline-offset-2 hover:text-accent-hover hover:decoration-accent">Prof. Andres Sevtsuk</a>.
            </div>
          </div>
        </div>
      </div>
